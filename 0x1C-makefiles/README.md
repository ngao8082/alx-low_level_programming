C - Makefiles
In this project, I learned to write Makefiles.

Tests ✔️
tests: Folder of test files which is provided by ALX School.
Helper Files 🙌
school.c: C function that outputs a seahorse in text. Used for Makefile practice purposes throughout project. Provided by ALX School.

main.c: Main C function that runs the function defined in school.c.
Header File 📁
m.h: Header file that  defines the function prototype used in school.c which is provided by alx School.
Tasks 📃
0. make -f 0-Makefile
